...
func Pipe(ctx context.Context) plug.Pipeline {
	...
	return plug.Pipeline{
		...
		sitePipe.PUT(`^/:website/settings/google$`, site.UpdateGoogleAuth),
		sitePipe.DELETE(`^/:website/settings/google-search$`, site.DeleteGoogleAuth),
		sitePipe.DELETE(`^/:website/settings/google-import$`, site.DeleteGoogleAuth),
		sitePipe.DELETE(`^/:website$`, site.DeleteSite),
		sitePipe.DELETE(`^/:website/stats$`, site.ResetStats),
		sitePipe.GET(`^/:website/import/google-analytics/view-id$`, site.ImportFromGoogleViewIdForm),
		sitePipe.POST(`^/:website/import/google-analytics/view-id$`, site.ImportFromGoogleViewId),
		sitePipe.GET(`^/:website/import/google-analytics/user-metric$`, site.ImportFromGoogleUserMetricNotice),
