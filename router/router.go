...
func Pipe(ctx context.Context) plug.Pipeline {
	...
	return plug.Pipeline{
		...
		pipe5.PathGET("/about", pages.Mark("about", "VINCE - about us")),
		pipe5.PathGET("/creators", pages.Mark("creators", "VINCE - for creators")),
		pipe5.PathGET("/agencies", pages.Mark("agencies", "VINCE - for agencies")),
		pipe5.PathGET("/ecommerce", pages.Mark("ecommerce", "VINCE - for ecomerce")),
		pipe5.PathGET("/contact", pages.Mark("contact", "VINCE - contact us")),
		pipe5.PathGET("/privacy", pages.Mark("privacy", "VINCE - privacy policy")),
		pipe5.PathGET("/data", pages.Mark("data", "VINCE - data policy")),
		pipe5.PathGET("/terms", pages.Mark("terms", "VINCE - Terms and Conditions")),
