...
func (c *FakeSites) Apply(ctx context.Context, site *vincev1alpha1.SiteApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Site, err error) {
	if site == nil {
...
func (c *FakeSites) ApplyStatus(ctx context.Context, site *vincev1alpha1.SiteApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Site, err error) {
	if site == nil {
		return nil, fmt.Errorf("site provided to Apply must not be nil")
	}
	data, err := json.Marshal(site)
