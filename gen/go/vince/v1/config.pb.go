...
var file_vince_v1_config_proto_rawDesc = []byte{
	...
	0x22, 0xbd, 0x03, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1a, 0x0a, 0x04, 0x64,
	...
	,
...
var file_vince_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_vince_v1_config_proto_goTypes = []interface{}{
	(*Version)(nil),             // 0: v1.Version
	(*Config)(nil),              // 1: v1.Config
	(*Tenant)(nil),              // 2: v1.Tenant
	(*Acme)(nil),                // 3: v1.Acme
	(*Domain)(nil),              // 4: v1.Domain
	(*GetDomainResponse)(nil),   // 5: v1.GetDomainResponse
	(*SendEventResponse)(nil),   // 6: v1.SendEventResponse
	(*durationpb.Duration)(nil), // 7: google.protobuf.Duration
	(*Credential_List)(nil),     // 8: v1.Credential.List
}
var file_vince_v1_config_proto_depIdxs = []int32{
	7, // 0: v1.Config.retention_period:type_name -> google.protobuf.Duration
	3, // 1: v1.Config.acme:type_name -> v1.Acme
	2, // 2: v1.Config.tenants:type_name -> v1.Tenant
	8, // 3: v1.Config.credentials:type_name -> v1.Credential.List
	4, // 4: v1.Tenant.domains:type_name -> v1.Domain
	4, // 5: v1.GetDomainResponse.domains:type_name -> v1.Domain
