...
`, template.innerHTML.trim());
  ...
  // js/liveview/live_socket.js
  var csrfToken = document.querySelector("meta[name='csrf-token']");
  var websocketUrl = document.querySelector("meta[name='websocket-url']");
  ...
  // js/liveview/combo-box.js
  var combo_box_default = (id) => ({
    isOpen: false,
    id,
    focus: null,
    ...
    suggestionsCount() {
      var _a;
      return (_a = this.$refs.suggestions) == null ? void 0 : _a.querySelectorAll("li").length;
    },
    hasCreatableOption() {
      var _a;
      return (_a = this.$refs.suggestions) == null ? void 0 : _a.querySelector("li").classList.contains("creatable");
    },
    leastFocusableIndex() {
    ...
    select() {
      var _a;
      (_a = this.$refs[`dropdown-${this.id}-option-${this.focus}`]) == null ? void 0 : _a.click();
      this.close();
      document.getElementById(this.id).blur();
    },
    scrollTo(idx) {
      var _a;
      (_a = this.$refs[`dropdown-${this.id}-option-${idx}`]) == null ? void 0 : _a.scrollIntoView(
  ...
  module_default.data("comboBox", combo_box_default);
  ...
  var changelogNotification = document.getElementById("changelog-notification");
  if (changelogNotification) {
    showChangelogNotification(changelogNotification);
    fetch("https://plausible.io/changes.txt", { headers: { "Content-Type": "text/plain" } }).then((res) => res.text()).then((res) => {
  ...
  function showChangelogNotification(el) {
    ...
    const notOlderThanThreeDays = Date.now() - lastUpdated < 1e3 * 60 * 60 * 72;
  ...
  var embedButton = document.getElementById("generate-embed");
  if (embedButton) {
