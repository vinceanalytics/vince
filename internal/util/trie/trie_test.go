...
func TestTrie(t *testing.T) {
	...
	t.Run("with mmap", func(t *testing.T) {
		...
		trie2 := NewTrieFromBuffer(buffer.Load(buffer.NewSlice(data)))
		check(t, trie2)
	})
}

func set(t *testing.T, trie *Trie) {
	t.Helper()
...
func check(t *testing.T, trie *Trie) {
	t.Helper()
