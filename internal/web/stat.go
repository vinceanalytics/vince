...
func Sources(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, metrics, v1.Field_source)
	if err != nil {
...
func UtmMediums(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, metrics, v1.Field_utm_medium)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func UtmCampaigns(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, metrics, v1.Field_utm_campaign)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func UtmContents(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, metrics, v1.Field_utm_content)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func UtmTerms(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, metrics, v1.Field_utm_term)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func UtmSources(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, metrics, v1.Field_utm_source)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func Pages(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, metrics, v1.Field_page)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func Countries(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	site := db.CurrentSite()
	params := query.New(r.URL.Query())
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, []string{"visitors"}, v1.Field_country)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func Regions(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	site := db.CurrentSite()
	params := query.New(r.URL.Query())
	o, err := breakdown.Breakdown(ctx, db.TimeSeries(), site.Domain, params, []string{"visitors"}, v1.Field_subdivision1_code)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
	for i := range o.Results {
		...
		reg := db.Location().GetRegion([]byte(code))
		m["code"] = code
		m["name"] = reg.Name
		m["flag"] = reg.Flag
	}
...
func Browsers(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	site := db.CurrentSite()
	params := query.New(r.URL.Query())
	o, err := breakdown.BreakdownVisitorsWithPercentage(ctx, db.TimeSeries(), site.Domain, params, v1.Field_browser)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func BrowserVersions(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	site := db.CurrentSite()
	params := query.New(r.URL.Query())
	o, err := breakdown.BreakdownVisitorsWithPercentage(ctx, db.TimeSeries(), site.Domain, params, v1.Field_browser_version)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func Os(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	site := db.CurrentSite()
	params := query.New(r.URL.Query())
	o, err := breakdown.BreakdownVisitorsWithPercentage(ctx, db.TimeSeries(), site.Domain, params, v1.Field_os)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func OsVersion(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	site := db.CurrentSite()
	params := query.New(r.URL.Query())
	o, err := breakdown.BreakdownVisitorsWithPercentage(ctx, db.TimeSeries(), site.Domain, params, v1.Field_os_version)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
...
func ScreenSize(db *db.Config, w http.ResponseWriter, r *http.Request) {
	...
	site := db.CurrentSite()
	params := query.New(r.URL.Query())
	o, err := breakdown.BreakdownVisitorsWithPercentage(ctx, db.TimeSeries(), site.Domain, params, v1.Field_device)
	if err != nil {
		db.Logger().Error("breaking down", "err", err)
		o = &breakdown.Result{}
	}
