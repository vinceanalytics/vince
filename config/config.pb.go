...
var file_config_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xed, 0x09, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x6f, 0x72, 0x73, 0x52, 0x04, 0x63, 0x6f, 0x72, 0x73, 0x1a, 0xca, 0x04, 0x0a, 0x06, 0x4d, 0x61,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x33, 0x0a, 0x03, 0x45,
...
var file_config_proto_goTypes = []interface{}{
	...
	(*Config_Mailer_Smtp)(nil),        // 6: config.Config.Mailer.Smtp
	(*Config_Mailer_Anonymous)(nil),   // 7: config.Config.Mailer.Anonymous
	(*Config_Mailer_Plain)(nil),       // 8: config.Config.Mailer.Plain
	(*Config_Mailer_OauthBearer)(nil), // 9: config.Config.Mailer.OauthBearer
...
var file_config_proto_depIdxs = []int32{
	...
	10, // 2: config.Config.flush_interval:type_name -> google.protobuf.Duration
	1,  // 3: config.Config.log_level:type_name -> config.Config.LogLevel
	3,  // 4: config.Config.cors:type_name -> config.Cors
	5,  // 5: config.Config.Mailer.address:type_name -> config.Config.Address
	6,  // 6: config.Config.Mailer.smtp:type_name -> config.Config.Mailer.Smtp
	7,  // 7: config.Config.Mailer.Smtp.anonymous:type_name -> config.Config.Mailer.Anonymous
	8,  // 8: config.Config.Mailer.Smtp.plain:type_name -> config.Config.Mailer.Plain
	9,  // 9: config.Config.Mailer.Smtp.oauth_bearer:type_name -> config.Config.Mailer.OauthBearer
