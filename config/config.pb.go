...
var file_config_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0xa9, 0x01, 0x0a, 0x07,
	...
	0x35, 0x31, 0x39, 0x4b, 0x65, 0x79, 0x50, 0x61, 0x69, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x67,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x67, 0x65, 0x1a, 0x49, 0x0a, 0x07,
...
var file_config_proto_depIdxs = []int32{
	...
	17, // 15: config.Firewall.block:type_name -> config.Firewall.Match
	17, // 16: config.Firewall.allow:type_name -> config.Firewall.Match
	11, // 17: config.Config.Mailer.address:type_name -> config.Config.Address
	12, // 18: config.Config.Mailer.smtp:type_name -> config.Config.Mailer.Smtp
	13, // 19: config.Config.Mailer.Smtp.anonymous:type_name -> config.Config.Mailer.Anonymous
	14, // 20: config.Config.Mailer.Smtp.plain:type_name -> config.Config.Mailer.Plain
	15, // 21: config.Config.Mailer.Smtp.oauth_bearer:type_name -> config.Config.Mailer.OauthBearer
	18, // 22: config.Firewall.Match.ip:type_name -> config.Firewall.IP
