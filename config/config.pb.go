...
var file_config_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf7, 0x07, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x73, 0x53, 0x65, 0x6c, 0x66, 0x48, 0x6f, 0x73, 0x74, 0x1a, 0xca, 0x04, 0x0a, 0x06, 0x4d, 0x61,
...
var file_config_proto_goTypes = []interface{}{
	...
	(*Config_Mailer)(nil),             // 2: config.Config.Mailer
	(*Config_Address)(nil),            // 3: config.Config.Address
	(*Config_Mailer_Smtp)(nil),        // 4: config.Config.Mailer.Smtp
	(*Config_Mailer_Anonymous)(nil),   // 5: config.Config.Mailer.Anonymous
	(*Config_Mailer_Plain)(nil),       // 6: config.Config.Mailer.Plain
	(*Config_Mailer_OauthBearer)(nil), // 7: config.Config.Mailer.OauthBearer
	(*durationpb.Duration)(nil),       // 8: google.protobuf.Duration
}
var file_config_proto_depIdxs = []int32{
	0, // 0: config.Config.env:type_name -> config.Config.Env
	2, // 1: config.Config.mailer:type_name -> config.Config.Mailer
	8, // 2: config.Config.flush_interval:type_name -> google.protobuf.Duration
	3, // 3: config.Config.Mailer.address:type_name -> config.Config.Address
	4, // 4: config.Config.Mailer.smtp:type_name -> config.Config.Mailer.Smtp
	5, // 5: config.Config.Mailer.Smtp.anonymous:type_name -> config.Config.Mailer.Anonymous
	6, // 6: config.Config.Mailer.Smtp.plain:type_name -> config.Config.Mailer.Plain
	7, // 7: config.Config.Mailer.Smtp.oauth_bearer:type_name -> config.Config.Mailer.OauthBearer
