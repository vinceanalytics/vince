...
* Avoid named return values. See
  [#3017](https://github.com/gernest/vince/boulder/pull/3017) for an example of a
...
[release.md](https://github.com/gernest/vince/boulder/docs/release.md). New
...
environment](https://github.com/gernest/vince/boulder/blob/main/README.md#setting-up-boulder)
...
Boulder-tools
README](https://github.com/gernest/vince/boulder/blob/main/test/boulder-tools/README.md)
...
doc](https://github.com/gernest/vince/boulder/blob/main/docs/acme-divergences.md).
...
doc](https://github.com/gernest/vince/boulder/blob/main/docs/acme-implementation_details.md).
