...
import (
	...
	bmail "github.com/gernest/vince/boulder/mail"
...
func (m *mailer) findExpiringCertificates(ctx context.Context) error {
	...
	for i, expiresIn := range m.nagTimes {
		...
		//
		// 0: https://github.com/gernest/vince/boulder/issues/2002
...
func main() {
	...
	for _, nagDuration := range c.Mailer.NagTimes {
		...
		// time rather than after. See https://github.com/gernest/vince/boulder/pull/1029
