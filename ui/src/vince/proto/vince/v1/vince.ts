...
/**
 * @generated from protobuf message v1.Block
 */
export interface Block {
}
/**
 * @generated from protobuf message v1.Block.Key
 */
export interface Block_Key {
    ...
    store?: StoreKey;
    /**
     * @generated from protobuf field: v1.Block.Key.Kind kind = 2;
     */
    kind: Block_Key_Kind;
    /**
...
/**
 * @generated from protobuf enum v1.Block.Key.Kind
 */
export enum Block_Key_Kind {
    /**
     * @generated from protobuf enum value: METADATA = 0;
     */
    METADATA = 0,
    /**
     * @generated from protobuf enum value: INDEX = 1;
     */
    INDEX = 1
}
/**
 * @generated from protobuf message v1.Block.Index
 */
export interface Block_Index {
    /**
     ...
     *
     * @generated from protobuf field: repeated v1.Block.Index.Range time_range = 2;
     */
    timeRange: Block_Index_Range[];
}
/**
 * @generated from protobuf message v1.Block.Index.Range
 */
export interface Block_Index_Range {
    /**
...
export enum StorePrefix {
    ...
    SITES = 0,
    /**
     * @generated from protobuf enum value: BLOCKS = 1;
     */
    BLOCKS = 1,
    /**
...
/**
 * @generated MessageType for protobuf message v1.Block
 */
export const Block = new Block$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Block_Key$Type extends MessageType<Block_Key> {
    constructor() {
        super("v1.Block.Key", [
            { no: 1, name: "store", kind: "message", T: () => StoreKey },
            { no: 2, name: "kind", kind: "enum", T: () => ["v1.Block.Key.Kind", Block_Key_Kind] },
            { no: 3, name: "domain", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "uid", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<Block_Key>): Block_Key {
        const message = { kind: 0, domain: "", uid: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<Block_Key>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Block_Key): Block_Key {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Block_Key, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* v1.StoreKey store = 1; */
        if (message.store)
            StoreKey.internalBinaryWrite(message.store, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* v1.Block.Key.Kind kind = 2; */
        if (message.kind !== 0)
...
/**
 * @generated MessageType for protobuf message v1.Block.Key
 */
export const Block_Key = new Block_Key$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Block_Index$Type extends MessageType<Block_Index> {
    constructor() {
        super("v1.Block.Index", [
            { no: 1, name: "row_group_bitmap", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "time_range", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Block_Index_Range }
        ]);
    }
    create(value?: PartialMessage<Block_Index>): Block_Index {
        const message = { rowGroupBitmap: [], timeRange: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<Block_Index>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Block_Index): Block_Index {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated bytes row_group_bitmap */ 1:
                    ...
                    break;
                case /* repeated v1.Block.Index.Range time_range */ 2:
                    message.timeRange.push(Block_Index_Range.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: Block_Index, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated v1.Block.Index.Range time_range = 2; */
        for (let i = 0; i < message.timeRange.length; i++)
            Block_Index_Range.internalBinaryWrite(message.timeRange[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message v1.Block.Index
 */
export const Block_Index = new Block_Index$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Block_Index_Range$Type extends MessageType<Block_Index_Range> {
    constructor() {
        super("v1.Block.Index.Range", [
            { no: 1, name: "min", kind: "message", T: () => Timestamp },
            { no: 2, name: "max", kind: "message", T: () => Timestamp }
        ]);
    }
    create(value?: PartialMessage<Block_Index_Range>): Block_Index_Range {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<Block_Index_Range>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Block_Index_Range): Block_Index_Range {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Block_Index_Range, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message v1.Block.Index.Range
 */
export const Block_Index_Range = new Block_Index_Range$Type();
// @generated message type with reflection information, may provide speed optimized methods
