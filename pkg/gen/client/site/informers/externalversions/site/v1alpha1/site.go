...
import (
	...
	sitev1alpha1 "github.com/gernest/vince/pkg/apis/site/v1alpha1"
	versioned "github.com/gernest/vince/pkg/gen/client/site/clientset/versioned"
	internalinterfaces "github.com/gernest/vince/pkg/gen/client/site/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/gernest/vince/pkg/gen/client/site/listers/site/v1alpha1"
...
func (f *siteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sitev1alpha1.Site{}, f.defaultInformer)
}
